...
`git clone https://github.com/Petrichao/cat_charity_fund.git` <br>
...
6. Создайте файл .env в корне проекта и заполните его следющим образом.
- APP_TITLE=Сервис пожертвования котикам <br>
- DESCRIPTION=Описаниие из env <br>
- DATABASE_URL=sqlite+aiosqlite:///./fastapi.db <br>
- SECRET= SECRET <br>
- FIRST_SUPERUSER_EMAIL=user@example.com <br>
- FIRST_SUPERUSER_PASSWORD=qwerty10 <br>
